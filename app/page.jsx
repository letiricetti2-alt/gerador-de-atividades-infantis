export default function Home() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#FFD33F]">
      <div className="relative max-w-[880px] w-[92%] bg-[#FFF3B0] rounded-[56px] shadow-[20px_24px_0_#E0A72A] px-12 pt-[140px] pb-16 overflow-hidden">

        {/* --- TINA E BALÃO --- */}
        <div className="absolute -top-[210px] left-[40px] flex items-start gap-4">
          <img
        ...
        {/* --- TÍTULO --- */}
        <h1 className="text-center text-[#1E1464] text-[92px] leading-[90px] font-extrabold drop-shadow-[10px_10px_0_#FFD84D] tracking-tight mb-0 -mt-4">
          Gerador de<br />Atividades<br />Infantis
        </h1>

        {/* --- PERSONAGENS --- */}
        <div className="flex justify-between items-end mb-14 mt-[-20px] scale-[1.25]">
          <div className="flex flex-col items-center gap-3">
            ...
            />
            <span className="text-[30px] font-bold text-[#1E1464]">Luno</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            <img
              ...
              className="w-[250px] h-auto"
            />
            <span className="text-[30px] font-bold text-[#1E1464]">Malu</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            />
            <span className="text-[30px] font-bold text-[#1E1464]">Theo</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            <img
              ...
              className="w-[250px] h-auto"
            />
            <span className="text-[30px] font-bold text-[#1E1464]">Nilo</span>
          </div>
        </div>
